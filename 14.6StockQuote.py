...
def find_related_options(user_input):
    ...
    options_with_scores = process.extract(user_input, stock_options.keys(), limit=5)
    related_options = [(option, stock_options[option]) for option, score in options_with_scores]
